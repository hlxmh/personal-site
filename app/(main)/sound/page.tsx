...
export default function Home() {
  asciify('public/igor.jpg', options, function (err, asciified) {
    ...
    typeof asciified === "string" ? ascii_img.__html = convert.toHtml(asciified) : ascii_img = "";
  });
    
  return (
    <>
    <div className={`flex justify-center`}>
      <div className={`leading-[1.2] w-0 ${style.glow}`} dangerouslySetInnerHTML={ ascii_img }></div>
    </div>
    {/* <YTPlayer></YTPlayer> */}
    </>
  );
